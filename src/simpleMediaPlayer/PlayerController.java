...
public class PlayerController {
    ...
    private double currentHeight;    //当前整个播放器的尺寸
    ...
    //程序启动项，传入必要参数
    public void start(String url,boolean popup,double width,double height){
        this.url = url;
        this.popup = popup;
                ...
                if (scene!= null) {
                    scene.widthProperty().addListener(new ChangeListener<Number>() {
                        ...
                        public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                            setSize(newValue.doubleValue(),currentHeight);}
                    });
                    scene.heightProperty().addListener(new ChangeListener<Number>() {
                        @Override
                        public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                            setSize(currentWidth,newValue.doubleValue());
                        }
                    });
                }
